    ...
    public class Jogo extends JFrame implements KeyListener {
        ...
        public Jogo(String arquivoMapa) {
            ...
            // Barra de status
            statusBar = new JLabel("Vida: " + mapa.getVidaPersonagem());
        ...
        public void move(Direcao direcao) {
            ...
            if (statusBar != null)
                statusBar.setText("Vida: " + mapa.getVidaPersonagem());
        ...
        private void desenhaInimigos(Graphics g){
            for(int i = 0; i< mapa.getInimigos().size(); i++){
                ...
                g.drawString(mapa.getInimigos().get(i).getSimbolo(), mapa.getInimigos().get(i).getX(), mapa.getInimigos().get(i).getY());
            }
        ...
        private void desenhaVidas(Graphics g){
            for(int i = 0; i< mapa.getVidas().size(); i++){
                ...
                g.drawString(mapa.getVidas().get(i).getSimbolo(), mapa.getVidas().get(i).getX(), mapa.getVidas().get(i).getY());
            }
